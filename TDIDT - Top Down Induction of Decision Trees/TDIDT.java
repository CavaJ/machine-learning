...
public class TDIDT
{
	...
	//list to hold the used attribute indices
	private static ArrayList<Integer> usedAttributeIndexes;
	
	//list to hold split values in correspondence with usedAttributeIndexes
	private static ArrayList<Integer> splitValues;
	
	//variable to name nodes for the output.txt file.
	private static int nodeId;
	
	//printWriter to write calculations on calculations.txt file
	...
	{	
		...
		//write the output to output.txt file, and calculations to calculations.txt file.
